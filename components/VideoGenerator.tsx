        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex flex-col h-full">
          <fieldset disabled={isLoading} className="space-y-6 flex-grow">
             <div className="flex items-center gap-2">
                ...
                />
                {isVeo3 && <span className="mt-4 bg-green-500/20 text-green-300 text-xs font-bold px-2 py-1 rounded-full">NEW</span>}
            </div>
                   ...
                   <div className="flex items-center justify-between flex-wrap gap-2 text-xs">
                      <div className="flex items-center gap-2">
                          <input
                              ...
                              className="h-4 w-4 rounded text-green-600 bg-gray-700 border-gray-600 focus:ring-green-500 focus:ring-offset-gray-900 disabled:opacity-50"
                          />
                          <label 
          ...
          <div className="pt-4 border-t border-gray-800">
              {isLoading ? (
                  ...
                  <Button type="submit" disabled={scenes.some(s => !s.prompt.trim())} className="w-full text-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {outputs.map((output, index) => (
                        <div key={output.id} className="space-y-2 bg-gray-900/50 p-2 rounded-lg">
                             <h3 className="text-sm font-semibold text-gray-400 text-center">{t('sceneLabel')} {index + 1}</h3>
